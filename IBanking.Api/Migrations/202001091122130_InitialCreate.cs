    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .ForeignKey("dbo.AspNetUsers", t => t.BankAccountId)
                ...
                c => new
                    {
                        ...
                        BankAccount_BankAccountId = c.String(maxLength: 128),
                    })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.BankAccounts", "BankAccountId", "dbo.AspNetUsers");
