...
namespace IBanking.Api.Providers
{
    ...
    public class ApplicationOAuthProvider : OAuthAuthorizationServerProvider
    {
        ...
        private ApplicationDbContext context_ { get; set; }
        ...
        public ApplicationOAuthProvider(string publicClientId)
        {
            ...
            context_ = new ApplicationDbContext();
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            var userExist = context_.BankAccounts.Any(a => a.BankAccountId == user.Id);
            if (!userExist)
            {
                ...
                await bankAccountRepository.CreateAccount(bankAccount);
